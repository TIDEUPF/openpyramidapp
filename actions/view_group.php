...
if(isset($_SESSION['user'])){
	...
	$fid = (int) $_GET['fid'];
	$res2 = mysqli_query($link, "select fname, pg_level, pg_group, pg_group_id from pyramid_groups, flow where pg_fid = '$fid' and pg_fid = fid order by pg_level ASC");
...
<html>
  ...
  <?php include('topnav.php'); ?>
    <div class="container">
		...
		<?php		
		if(!$py_created) {
			echo '<br /><span class="label btn-success">The pyramid still is not created.</span><br />';
		} else {
