...
<div id="answer-frame">
    <form method="post">
        <div id="answer-header-frame">
            ...
            <div>
                <div id="answer-header-text">None of your group members submitted question! So you will see no option to rate!<br>But you will be level up and continue with the activity. Visit the app tomorrow!</div>
            </div>
