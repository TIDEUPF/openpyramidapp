    ...
    <form action="student_login.php" method="post" data-ajax="false">
        ...
        <div id="activity-middle-frame">
            ...
            <div>
                ...
                <?php else: ?>
                    <input type="text" data-clear-btn="true" name="usr" value="" placeholder="username">
                <?php endif;?>
            </div>
        ...
        <div id="activity-footer-frame">
            ...
            <?php if($force_email):?>
                <div id="email-petition">
                    <?php echo htmlspecialchars("It is recommended to provide an "). '<span class="bold">email address</span>' . htmlspecialchars(" here so that you will be automatically notified about the activity progression to make it much easier. This email address does not necessarily have to be the same as your FutureLearn course email.")?>

                    <a href="mailto:ssp.clfp@upf.edu?Subject=Pyramid%20App"><?=TS("Contact address")?>: ssp.clfp@upf.edu</a>
                </div>
            <?php else: ?>
                <div>
                    <?php echo htmlspecialchars("For more information on how the app works, you can watch the following video. ")?>
                </div>
            <?php endif;?>
