        ...
        "elements": {
            ...
            "global-available-student": function ($elem) {
                ...
                if(pyramid_event !== true) {
                    ...
                    $elem.find('.username a').prop("pyramid_event", true);
                }
            ...
            "global-header-pyramid": function ($elem) {
                ...
                if (pyramid_data.data.results.is_complete) {
                    $('#winning-answer-summary .winning-event-label').show();
            ...
            "global-group": function ($elem) {
                ...
                if(pyramid_event !== true) {
                    $elem.on('click', global_group_click);
    ...
    "init": {
        "start": function () {
            ...
            var user_tree = {
                ...
                "$parent_element": $('#available-students'),
                //"insert": "winning-answers",
                "section": "global",
